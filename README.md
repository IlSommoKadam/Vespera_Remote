...
| 0.6.23 | 70 | **Fase 1 porte**: inventario completo FTP+API in tab Wi‑Fi; cartella USER con porta reale in Foto/HD; tab **Telescopio** (stato + comandi Park/Stop/Init senza Singularity) |
| 0.6.24 | 71 | Release su `main`: tab Telescopio + inventario porte (fase 1) |
